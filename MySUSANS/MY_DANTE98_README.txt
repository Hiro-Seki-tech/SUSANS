MY SUSANS v0.7 / Dante98 Reviver core
2026-08-13
...
【ゲームZIPを直接読み込む】
MY SUSANS v0.7.11 では、登録済みメニューを残したまま、PC上のZIPを直接開けます。
タイトル画面の「📂 ゲームZIPを直接読み込む」を押し、Dante98 / Dante98II のZIPを選んでください。
AUTOEXEC.BAT / ED.BAT / GAME.BAT を確認して起動方法を自動判定します。
一時的に開くだけなら games.json への登録は不要です。
